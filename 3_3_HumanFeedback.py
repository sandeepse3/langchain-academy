...
# %%
graph.update_state(thread, {"messages": [HumanMessage(content="No. Multiply 3 and 4.")]}, as_node="human_feedback")
# %%
for event in graph.stream(None, thread, stream_mode='values'):
    event['messages'][-1].pretty_print()

# %%
graph.update_state(thread, {"messages": [HumanMessage(content="Add 7 to it")]}, as_node="human_feedback")
# %%
for event in graph.stream(None, thread, stream_mode='values'):
    event['messages'][-1].pretty_print()
# %%
